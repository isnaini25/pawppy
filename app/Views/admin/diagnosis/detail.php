                    ...
                    <div class="row">
                        <div class="col-12">
                            <table class="table table-striped table-md">
                                ...
                                <tr>
                                    <td><?php
                                        if ($diagnosis['id_user'] == 0) {
                                            echo "Guest";
                                        } else {
                                            echo $diagnosis['fullname'];
                                        }; ?></td>
                                    <td><?= date_format(date_create($diagnosis['tanggal']), 'D, d M Y'); ?></td>
                                </tr>
                    ...
                    <div class="row">
                        <div class="col-6 col-lg-3 col-md-12 col-sm-12">
                            <div class="chocolat-parent d-flex justify-content-center">
                                <a href="/img/<?= $hasilPenyakit['gambar']; ?>" class="chocolat-image" title="<?= $hasilPenyakit['gambar']; ?>">
                                    <div data-crop-image="200">
                                        <img alt="image" src="/img/<?= $hasilPenyakit['gambar']; ?>" class="img-fluid gambar-penyakit-detail">
                                    </div>
                                </a>
                            </div>
                        </div>
