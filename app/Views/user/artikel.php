                ...
                <article class="article article-style-c">
                    ...
                    <div class="article-details">
                        <div class="article-category">
                            ...
                            <a href="<?= base_url('artikel-detail/' . $a['id_artikel']) ?>"><?= date_format(date_create($a['tanggal']), 'd/M/Y'); ?></a>
                        </div>
                        <div class="article-title">
                            <h2><a href="<?= base_url('artikel-detail/' . $a['id_artikel']) ?>"><?= $a['judul']; ?></a></h2>
                        </div>
                        <p><?php
                        ...
                        <div class="article-cta">
                            <a href="<?= base_url('artikel-detail/' . $a['id_artikel']) ?>" class="btn btn-primary">Read
                                More</a>
                        </div>
                    </div>
                </article>
